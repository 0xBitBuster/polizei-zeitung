...
const MissingPersonSchema = new mongoose.Schema({
    ...
    lastSeenLocation: {
        type: String,
        minlength: [1, "Der Ort, an dem die Person zuletzt gesehen wurde, muss mindestens 1 Zeichen lang sein."],
        maxlength: [150, "Der Ort, an dem die Person zuletzt gesehen wurde, darf höchstens 150 Zeichen lang sein."],
        trim: true
    },
    lastSeenDateCrawled: {
        type: String,
    ...
    height: {
        type: Number,
        min: [1, "Die Höhe der vermissten Person muss mindestens 1cm betragen."]
    },
    nationality: {
        type: String,
